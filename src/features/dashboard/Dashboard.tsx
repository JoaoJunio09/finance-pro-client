          ...
          <div className="relative w-full overflow-hidden pb-12 pt-8 lg:pt-16 px-6 lg:px-12 flex flex-col">
            ...
            <div className="relative z-10 w-full rounded-[32px] flex flex-col lg:flex-row items-center lg:items-start justify-between overflow-hidden">
              <div className="flex flex-col items-center lg:items-start text-center lg:text-left relative z-10 w-full">
                <div className="flex items-center gap-2 text-[11px] uppercase tracking-widest text-[var(--text-muted)] font-bold mb-2">
                  <Fingerprint className="w-3.5 h-3.5 text-[#8B5CF6]" /> Patrimônio Líquido
                </div>
                
                <h2 className="font-display text-5xl lg:text-7xl font-light text-main tracking-tighter leading-none mb-1 tabular-nums">
                  R$ 12.430<span className="text-[var(--text-muted)] text-3xl lg:text-5xl">,22</span>
                </h2>

                <p className="text-[12px] text-[var(--text-muted)] opacity-60 font-light tracking-wide mb-10">
                ...
                <div className="flex flex-row items-center justify-center lg:justify-start gap-10 lg:gap-16 w-full">
                  <div className="flex flex-col items-center lg:items-start group cursor-default">
                    <div className="flex items-center gap-2 mb-1.5">
                      <TrendingUp className="w-4 h-4 text-emerald-500 transition-transform duration-300 ease-out group-hover:-translate-y-1" />
                      <span className="text-[11px] uppercase tracking-widest text-[var(--text-muted)] font-bold">Entradas</span>
                    </div>
                    <span className="font-display text-2xl lg:text-3xl font-medium text-emerald-500 tabular-nums">R$ 6.230</span>
                  </div>
                  
                  <div className="flex flex-col items-center lg:items-start group cursor-default">
                    <div className="flex items-center gap-2 mb-1.5">
                      <TrendingDown className="w-4 h-4 text-rose-500 transition-transform duration-300 ease-out group-hover:translate-y-1" />
                      <span className="text-[11px] uppercase tracking-widest text-[var(--text-muted)] font-bold">Saídas</span>
                    </div>
                    <span className="font-display text-2xl lg:text-3xl font-medium text-rose-500 tabular-nums">R$ 2.110</span>
                  </div>
                </div>
              </div>
